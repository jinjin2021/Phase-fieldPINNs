...
def read_pf_data(time, dLen):
    pf_filename = to_absolute_path(f"PINNs2D_data/imp_50pTD512t0.2_seed100_2000/PF_{int(time):05d}.npz")
...
def read_eta_data(time, dLen):
    eta_filename = to_absolute_path(f"PINNs2D_data/imp_50pTD512t0.2_seed100_2000/ETA_{int(time):05d}.npz")
...
@modulus.main(config_path="conf", config_name="config_inference")
